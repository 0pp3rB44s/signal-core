...
- [ ] SHORT-bias — nu HARD bewezen met exchange-truth export (206 trades, 30-06 t/m 12-07, reports/exchange_truth_analysis_20260713.md): SHORT n=114 -3.05 USDT PF 0.60 vs LONG n=92 +3.45 USDT PF 1.68. Eigenaar-besluit nodig: shorts uitschakelen, of strengere confluence-eis (continuation.py heeft al SHORT_MIN_* drempels). Grootste directe winst-knop die er nu ligt.
