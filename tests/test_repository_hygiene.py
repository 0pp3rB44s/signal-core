...
def test_path_classifier_rejects_environment_operational_cache_and_editor_paths():
    forbidden = [
        ".env",
        ".env.forward",
...
def test_path_classifier_accepts_normal_source_and_test_paths():
    result = _run(
        "--check-paths",
